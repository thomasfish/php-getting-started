...
function newVillagers() {
  ...
  document.getElementById("villager1").children[0].src = "Imgs/" + String(villagerId1 + 1).padStart(3, '0') + ".png";
  document.getElementById("villager1").children[1].innerHTML = villagerNames[villagerId1];

  document.getElementById("villager2").children[0].src = "Imgs/" + String(villagerId2 + 1).padStart(3, '0') + ".png";
